...
local anaconda_path = pathJoin(software_path, 'anaconda3-5.0.0')

-- Start miniconda
prepend_path('PATH', pathJoin(anaconda_path, 'bin'));
setenv('PYTHONPATH', pathJoin(anaconda_path, 'lib/python3.6/site-packages'));
